...
<ul class="woocommerce-side-nav woocommerce-checkout-nav">
	<li class="active">
		<a href="#player-information">
			<?php _e('Player Information' , 'Avada'); ?>
		</a>
	</li>
	<li>
		<a href="#billing">
...
<form name="checkout" method="post" class="checkout woocommerce-content-box" action="<?php echo esc_url( $get_checkout_url ); ?>">
	...
	<?php if ( sizeof( $checkout->checkout_fields ) > 0 ) : ?>
		...
		<div class="" id="customer_details">
			...
			<div class="col-2" id="player-information">

				<?php do_action( 'br_checkout_player_information' ); ?>

				<a href="#billing" class="default button small continue-checkout"><?php _e('Continue', 'Avada'); ?></a>
	...
	<div id="payment-container">
		<h2 id="order_review_heading"><?php _e( 'Review &amp Pay', 'Avada' ); ?></h2>
...
<script>
	(function($){
		$( '#billing' ).hide();
		$( '.product-thumbnail a, .product-info a' ).attr('href','javascript:void(0)');
